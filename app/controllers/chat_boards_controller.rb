class ChatBoardsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @chat_board.save
        format.html { redirect_to chat_board_path(@chat_board.post_id), notice: "Chat was successfully delivered." }
  ...
  def update
    respond_to do |format|
      if @chat_board.update(chat_board_params)
        format.html { redirect_to post_path(@chat_board.post_id), notice: "Chat was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to post_path(post_id), notice: "Chat was successfully deleted.", status: :see_other }
